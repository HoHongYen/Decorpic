...
<div class="flex flex-col items-center w-[500px] mx-auto">
   <h3 class="mb-5 text-3xl font-bold underline text-center"> Thêm sản phẩm</h3>
   <form action="{{ route("products.store") }}" method="post" enctype="multipart/form-data">
    @csrf
        <div class="mb-4">
            <label for="image" class="block text-gray-700 font-bold mb-2">Ảnh sản phẩm:</label>
        ...
        <div>
            <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" type="submit">Thêm sản phẩm</button>
        </div>
   </form>
</div>
@endsection
